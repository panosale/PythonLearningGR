...
# V1.2 - Παίζει ηχητική ειδοποίηση μόνο η επιλεγμένη γλώσσα είναι διαφρετική από την προεπιλεγμένη του λειτουργικού
...
import keyboard # Βιβλιοθήκη ελέγχου πληκτρολογίου  # ***** ΝΑ ΓΙΝΕΙ ΕΛΕΓΧΟΣ ΜΕ ΤΗ ΧΡΗΣΗ LISTENER ΑΠΟ PYNPUT (ΣΕ ΕΠΟΜΕΝΗ ΕΚΔΟΣΗ)
...
def get_keyboard_language():
    ...
    handle = user32.GetForegroundWindow()                   # Get the current active window handle
...
greek_sound = "D:\Common\Programming\GitHub\PythonLearningGR\MyPrograms\KeyboardStatusAnnouncement\Sounds\SoundsGreek.wav"
english_sound = "D:\Common\Programming\GitHub\PythonLearningGR\MyPrograms\KeyboardStatusAnnouncement\Sounds\SoundsEnglish.wav"
capslock_on_sound = "D:\Common\Programming\GitHub\PythonLearningGR\MyPrograms\KeyboardStatusAnnouncement\Sounds\SoundsCapsLockON.wav"
...
while True:
    current_window = w.GetWindowText(w.GetForegroundWindow())
    if keyboard.is_pressed: # ***** ΝΑ ΓΙΝΕΙ ΕΛΕΓΧΟΣ ΜΕ ΤΗ ΧΡΗΣΗ LISTENER ΑΠΟ PYNPUT (ΣΕ ΕΠΟΜΕΝΗ ΕΚΔΟΣΗ)
