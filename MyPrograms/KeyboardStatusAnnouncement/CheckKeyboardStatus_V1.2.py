...
import win32api,win32con # Βιβλιοθήκη για έλεγχο κατάστασης πληκτρολογίου. Εγκατάσταση της βιλβιοθήκης pywin32 με την εντολή: pip install pywin32
...
import keyboard # Βιβλιοθήκη ελέγχου πληκτρολογίου. Εγκατάσταση της βιλβιοθήκης keyboard με την εντολή: pip install keyboard  # ***** ΝΑ ΓΙΝΕΙ ΕΛΕΓΧΟΣ ΜΕ ΤΗ ΧΡΗΣΗ LISTENER ΑΠΟ PYNPUT (ΣΕ ΕΠΟΜΕΝΗ ΕΚΔΟΣΗ)
from playsound import playsound # Βιβλιοθήκη εκτέλεσης ήχων. Εγκατάσταση της βιλβιοθήκης playsound με την εντολή: pip install playsound
